...
HD_PWD='C:/SharedProjects/Sadias_Directory/project_exercise_blaze/project_exercise_blaze.runs/design_1_led_ctl_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_led_ctl_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_led_ctl_0_2.tcl
